        ...
        <header>
            ...
            <div class="flex-container">
                <?php
                    ...
                    while ($i <= 17) {
                        if ($i<10) {
                            echo '<button onclick="goal_progress('.$i.',20)" class="progress-status"><img src="https://sdgs.un.org/sites/default/files/goals/E_SDG_Icons-0'.$i.'.jpg" class="sdg-pict goal'.$i.'" /><p class="progress-bar-text">0/5</p><p class="stg-progress" style="width: 0%"></p></button>';
                        } else {
                            echo '<button onclick="goal_progress('.$i.',20)" class="progress-status"><img src="https://sdgs.un.org/sites/default/files/goals/E_SDG_Icons-'.$i.'.jpg" class="sdg-pict goal'.$i.'" /><p class="progress-bar-text">0/5</p><p class="stg-progress" style="width: 0%"></p></button>';
                        }
                        $i ++ ;
                    }
                ?>
            ...
            <div class="flex-container">
                <?php
                    ...
                    while ($i <= 8) {
                        if ($i<10) {
                            echo '<button onclick="select_goal('.$i.')"><img src="https://sdgs.un.org/sites/default/files/goals/E_SDG_Icons-0'.$i.'.jpg" class="sdg-pict goal'.$i.'" /></button>';
                        } else {

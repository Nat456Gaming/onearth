<template>
    <div class="flex flex-col bg-[#252525] h-[12%] p-4 fixed w-full top-[10%]" id="search-container">
        <div class="w-full h-2/3 flex flex-row mb-2 rounded-md px-4">
            <form class="w-11/12 h-full rounded-md">
                <input type="text" placeholder="Search ..." name="search-bar" class="w-full rounded-3xl p-2">
            </form>
        ...
        <div class="w-full h-1/3 flex flex-row justify-center items-center">
            <button class="w-1/4">
              <router-link to="/search/challenge" class="text-white">Challenges</router-link>
            </button>
            <button class="w-1/4">
              <router-link to="/search/user" class="text-white">People</router-link>
            </button>
        </div>
    </div>
    <section class="mt-56 p-4">

<template>
    <div class="flex flex-col bg-[#252525] h-[13%] p-4 fixed w-full top-[10%]" id="search-container">
        ...
        <div class="w-full h-1/3 flex flex-row justify-center items-center">
            <button class="w-1/4">
              <router-link to="/search/challenge" class="text-white text-xl text-center" active-class="activeMenu">Challenges</router-link>
            </button>
            <button class="w-1/4">
              <router-link to="/search/user" class="text-white text-xl text-center" active-class="activeMenu">People</router-link>
            </button>
        </div>
    </div>
    <section class="p-4">
